...
int main()
{
	...
	double pctDogs = 100.0 * preferCats / surveyParticipants;   //should be: 100.0 * preferDogs / surveyParticipants
	double pctCats = 100.0 * preferDogs / surveyParticipants;   //should be: 100.0 * preferCats / surveyParticipants
